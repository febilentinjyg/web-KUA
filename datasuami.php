...
<div class="container">
    <h1 class="well">DATA SUAMI</h1>
	<div class="col-lg-12 well">
	<div class="row">
            <input type="hidden" placeholder="Enter First Name Here.." class="form-control" value="lk" name="jk">
					<div class="col-sm-12">
                        <div class="form-group">
						  <label>Warga Negara</label>
                            <select name="warganegara" class="form-control">  
                                ...
                                <option value="Tanpa Kewarganegaraan">Tanpa Kewarganegaraan</option>    
                            </select>
					   </div>
						<div class="row">
